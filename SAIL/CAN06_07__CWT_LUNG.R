...
all_data %>% 
  ...
  labs(title = "Monthly number of lung UCSR referrals", x = "Month", y = "Number of referrals") + 
...
ggplot(all_data, aes(month, prop_within_target, colour = year, group = year)) + 
  ...
  labs(title = "Proportion of lung cancer referrals starting treatment within target", x = "Month", y = "Proportion starting treatment within target") + 
...
ggplot(all_data, aes(month, total_starting_treatment, colour = year, group = year)) + 
  ...
  labs(title = "Number of people starting treatment for lung cancer", x = "Month", y = "Number starting treatment") + 
